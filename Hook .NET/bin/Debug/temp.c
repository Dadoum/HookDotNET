...
extern const unsigned char assembly_data_mod_exe [];
static const MonoBundledAssembly assembly_bundle_mod_exe = {"mod.exe", assembly_data_mod_exe, 5120};
extern const unsigned char assembly_data_mscorlib_dll [];
static const MonoBundledAssembly assembly_bundle_mscorlib_dll = {"mscorlib.dll", assembly_data_mscorlib_dll, 900608};
extern const unsigned char assembly_data_System_Core_dll [];
static const MonoBundledAssembly assembly_bundle_System_Core_dll = {"System.Core.dll", assembly_data_System_Core_dll, 163328};
...
extern const unsigned char assembly_data_Hook_Library_dll [];
static const MonoBundledAssembly assembly_bundle_Hook_Library_dll = {"Hook.Library.dll", assembly_data_Hook_Library_dll, 239104};
extern const unsigned char assembly_data_Mono_Cecil_dll [];
static const MonoBundledAssembly assembly_bundle_Mono_Cecil_dll = {"Mono.Cecil.dll", assembly_data_Mono_Cecil_dll, 339456};
extern const unsigned char assembly_data_Mod_Properties_dll [];
static const MonoBundledAssembly assembly_bundle_Mod_Properties_dll = {"Mod.Properties.dll", assembly_data_Mod_Properties_dll, 4608};
extern const unsigned char assembly_data_I18N_West_dll [];
static const MonoBundledAssembly assembly_bundle_I18N_West_dll = {"I18N.West.dll", assembly_data_I18N_West_dll, 7680};
extern const unsigned char assembly_data_I18N_dll [];
static const MonoBundledAssembly assembly_bundle_I18N_dll = {"I18N.dll", assembly_data_I18N_dll, 9728};

static const MonoBundledAssembly *bundled [] = {
	&assembly_bundle_mod_exe,
	...
	&assembly_bundle_Hook_Library_dll,
	&assembly_bundle_Mono_Cecil_dll,
	&assembly_bundle_Mod_Properties_dll,
...
static char *image_name = "mod.exe";
